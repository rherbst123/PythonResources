...
e = float(input("Enter the length in feet used by end post assembley: "))
s = float(input("Enter space between vines in feetL: "))

v = (r - (2 * e)) / (s)
print("The max number of rows will be:", format(int(v)))
